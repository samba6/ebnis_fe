...
export interface UpdateExperienceSomeSuccessFragment_experience_updatedEntries_UpdateEntryErrors {
  ...
  errors: UpdateExperienceSomeSuccessFragment_experience_updatedEntries_UpdateEntryErrors_errors | null;
}

export interface UpdateExperienceSomeSuccessFragment_experience_updatedEntries_UpdateEntrySomeSuccess_entry_dataObjects_DataObjectFullErrors_errors {
...
export interface UpdateExperienceSomeSuccessFragment_experience_updatedEntries_UpdateEntrySomeSuccess_entry_dataObjects_DataObjectFullErrors {
  __typename: "DataObjectFullErrors";
  errors: UpdateExperienceSomeSuccessFragment_experience_updatedEntries_UpdateEntrySomeSuccess_entry_dataObjects_DataObjectFullErrors_errors;
}
...
export type UpdateExperienceSomeSuccessFragment_experience_updatedEntries_UpdateEntrySomeSuccess_entry_dataObjects = UpdateExperienceSomeSuccessFragment_experience_updatedEntries_UpdateEntrySomeSuccess_entry_dataObjects_DataObjectFullErrors | UpdateExperienceSomeSuccessFragment_experience_updatedEntries_UpdateEntrySomeSuccess_entry_dataObjects_DataObjectSuccess;
...
export interface UpdateExperienceSomeSuccessFragment_experience_newEntries_CreateEntryErrorss_errors_meta {
...
export interface UpdateExperienceSomeSuccessFragment_experience_newEntries_CreateEntryErrorss_errors_dataObjects {
...
export interface UpdateExperienceSomeSuccessFragment_experience_newEntries_CreateEntryErrorss_errors {
  __typename: "CreateEntryErrorx";
  meta: UpdateExperienceSomeSuccessFragment_experience_newEntries_CreateEntryErrorss_errors_meta;
  /**
   ...
   */
  dataObjects: (UpdateExperienceSomeSuccessFragment_experience_newEntries_CreateEntryErrorss_errors_dataObjects | null)[] | null;
}

export interface UpdateExperienceSomeSuccessFragment_experience_newEntries_CreateEntryErrorss {
  __typename: "CreateEntryErrorss";
  errors: UpdateExperienceSomeSuccessFragment_experience_newEntries_CreateEntryErrorss_errors;
}
...
export type UpdateExperienceSomeSuccessFragment_experience_newEntries = UpdateExperienceSomeSuccessFragment_experience_newEntries_CreateEntryErrorss | UpdateExperienceSomeSuccessFragment_experience_newEntries_CreateEntrySuccess;
