...
export interface UpdateExperienceFragment_updatedEntries_UpdateEntryErrors {
  ...
  errors: UpdateExperienceFragment_updatedEntries_UpdateEntryErrors_errors | null;
}

export interface UpdateExperienceFragment_updatedEntries_UpdateEntrySomeSuccess_entry_dataObjects_DataObjectFullErrors_errors {
...
export interface UpdateExperienceFragment_updatedEntries_UpdateEntrySomeSuccess_entry_dataObjects_DataObjectFullErrors {
  __typename: "DataObjectFullErrors";
  errors: UpdateExperienceFragment_updatedEntries_UpdateEntrySomeSuccess_entry_dataObjects_DataObjectFullErrors_errors;
}
...
export type UpdateExperienceFragment_updatedEntries_UpdateEntrySomeSuccess_entry_dataObjects = UpdateExperienceFragment_updatedEntries_UpdateEntrySomeSuccess_entry_dataObjects_DataObjectFullErrors | UpdateExperienceFragment_updatedEntries_UpdateEntrySomeSuccess_entry_dataObjects_DataObjectSuccess;
...
export interface UpdateExperienceFragment_newEntries_CreateEntryErrorss_errors_dataObjects {
...
export interface UpdateExperienceFragment_newEntries_CreateEntryErrorss_errors {
  __typename: "CreateEntryErrorx";
  meta: UpdateExperienceFragment_newEntries_CreateEntryErrorss_errors_meta;
  /**
   ...
   */
  dataObjects: (UpdateExperienceFragment_newEntries_CreateEntryErrorss_errors_dataObjects | null)[] | null;
}

export interface UpdateExperienceFragment_newEntries_CreateEntryErrorss {
  __typename: "CreateEntryErrorss";
  errors: UpdateExperienceFragment_newEntries_CreateEntryErrorss_errors;
}
...
export type UpdateExperienceFragment_newEntries = UpdateExperienceFragment_newEntries_CreateEntryErrorss | UpdateExperienceFragment_newEntries_CreateEntrySuccess;
