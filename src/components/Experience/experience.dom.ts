...
export const offlineExperienceSyncedNotificationSuccessSelector = `${domPrefix}-success-notification`;
...
export const onlineExperienceSyncedNotificationSuccessDom = `js-${domPrefix}-synced-notification-success`;
